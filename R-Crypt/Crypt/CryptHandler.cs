...
//        private protected void OnStartingCrypt(CryptProgress progress)
//        {
//            progress.StartTimer();
//        }

//        private protected void OnProcessingCrypt(CryptProgress progress)
//        {
//            CryptProgressChanged?.Invoke(this, progress);
//        }

//        private protected void OnCompletedCrypt(CryptProgress progress)
//        {
...
//                await EncryptInternalAsync(saltedPasswordBytes, salt, ivKey, path, progress);
//            }

//            OnCompletedCrypt(progress);
//        }
...
//            {
//                var saltedPasswordBytes = saltedPassword.GetBytes(ProgramWideConfig.SaltSize);
//                await DecryptInternalAsync(saltedPasswordBytes, ivKey, path, progress);
//            }

//            OnCompletedCrypt(progress);
//        }

//        public async void EncryptListAsync(string pass, string[] paths)
//        {
//            progresses = new();
//            BackgroundProcesses = new BackgroundWorker[paths.Count()];
...
//                {
//                    BackgroundProcesses[index].DoWork += async (sender, e) =>
//                    {
//                        OnStartingCrypt(progresses[index]);

//                        using (var saltedPassword = new Rfc2898DeriveBytes(pass, salt, ProgramWideConfig.RfcIterations))
//                        {
//                            var saltedPasswordBytes = saltedPassword.GetBytes(ProgramWideConfig.SaltSize);
//                            await EncryptInternalAsync(saltedPasswordBytes, salt, ivKey, path, progresses[index]);
//                        }

//                        OnCompletedCrypt(progresses[index]);
//                    };
//                }
//            });
...
//        private async Task EncryptInternalAsync(byte[] saltedPass, byte[] salt, byte[] ivKey, string fileToEncrypt, CryptProgress cryptProgress)
//        {
...
//                    long remaining = cryptProgress.TotalByte;
...
//                        cryptProgress.CurrentByte = streamEncryptedFile.Position;
//                        OnProcessingCrypt(cryptProgress);
...
//        private async Task DecryptInternalAsync(byte[] saltedPass, byte[] IVkey, string fileToDecrypt, CryptProgress cryptProgress)
//        {
...
//                        cryptProgress.CurrentByte = streamToDecrypt.Position;
//                        OnProcessingCrypt(cryptProgress);
